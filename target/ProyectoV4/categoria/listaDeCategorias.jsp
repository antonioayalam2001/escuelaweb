...
<table class="table table-striped table-hover">
    ...
    <c:forEach items="${listado}" var="dto">
        ...
        <td class="align-middle "><a href="./CategoriasServlet?accion=ver&id=<c:out value="${dto.entidad.idCategoria}"/>" class="btnP"><c:out value="${dto.entidad.idCategoria}"/></a> </td>
        <td class="align-middle "><c:out value="${dto.entidad.nombreCategoria}"/>
        <td class="align-middle "><c:out value="${dto.entidad.descripcionCategoria}"/></td>
        <td class="align-middle "><a href="./CategoriasServlet?accion=eliminar&id=<c:out value="${dto.entidad.idCategoria}"/>" class="btn btn-danger p-2 rounded-circle"><i class='bx bxs-trash'></i></a></td>
        <td class="align-middle "><a href="./CategoriasServlet?accion=actualizar&id=<c:out value="${dto.entidad.idCategoria}"/>" class="btn btn-primary p-2 text-white rounded-circle"><i class='bx bx-edit bx-sm'></i></a></td>
    </tr>
...
<%--Ahora eliminamos el valor de la variable--%>
<c:remove var="income"/>
<p>After Remove Value is: <c:out value="${income}"/></p>

<%--Realizando el manejo de algun error--%>
